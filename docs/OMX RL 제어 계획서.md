...
| 항목 | 값 |
|---|---|
| 정책 버전 | `arm_delivery_residual_v3_robot_stay` |
| 정책 파일 | `/home/ktj/omx_train_ws/policies/latest/arm_delivery_residual_v3_robot_stay/arm_grasp_latest.zip` |
| 정책 크기 | `1,842,792 bytes` |
| 정책 SHA-256 | `07b69c0680521413ca8c40bf37c93993d74d47ccedc48f0c2ab7cb0a7991d6fe` |
| metadata SHA-256 | `7ccf47e7f486447a70cea78afbd0a892b6801d25d8e43cb1dd132198d141f123` |
| training config SHA-256 | `4f816534aaeaef5feaa447f91125df5b301db50f9ae78292d9a5bda03e5da4d8` |
| metadata `model_sha256` | `a62fb4c219f80d0a2020e8e741f5cbb0c5d77942e072200e1bf84bd3373c09af`, MuJoCo `scene.xml` checksum |
| 누적 step | `660,000` |
...
```text
omx_rl_control/models/policies/arm_delivery_residual_v3_robot_stay/
├── policy.zip
...
│   ├── base_stop_robust_100.yaml
│   ├── height_robust_100.yaml
...
| Stay | `[0.104311, 0.027612, -0.001534, -1.638291] rad` |
...
| pregrasp height offset | `0.0225 m` |
...
├── models/policies/arm_delivery_residual_v3_robot_stay/
└── omx_rl_control/
    ├── rl_control_node.py
    ├── model_contract.py
